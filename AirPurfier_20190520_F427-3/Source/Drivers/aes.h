...
**
** DESCRIPTION
**  This file contains aes configurations.   
**
** History:
**-----------------------------------------------------------------------------
**  Ver   Date         Author         Description
**-----------------------------------------------------------------------------
**  1.1   2016/06/20   Ryan Wu        The first release
**
*******************************************************************************/
...
******************************************************************************/
extern unsigned char local_key[16];
...
******************************************************************************/
extern int AesSetKey(Aes* aes, const byte* userKey, word32 keylen, const byte* iv, int dir);
extern int AesCbcEncrypt(Aes* aes, byte* out, const byte* in, word32 sz);
extern int AesCbcDecrypt(Aes* aes, byte* out, const byte* in, word32 sz);

extern int device_aes_encrypt(unsigned char * key, unsigned char  *data, unsigned int len);
extern unsigned char device_aes_decrypt(unsigned char * key, unsigned char *data, unsigned int len);
