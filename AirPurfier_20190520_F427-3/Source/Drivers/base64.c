...
unsigned char tlv_sum[4];           
unsigned char version[3]; 				//版本 
unsigned char modulus_head[4];
unsigned char modulus[128];				// RSA合数模 n 
unsigned char public_head[2];
unsigned char publicExponent[3]; 		//RSA公开幂 e 
unsigned char private_head[3];
...
unsigned char decode_output[4096]; 
