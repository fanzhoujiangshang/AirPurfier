...
**
** DESCRIPTION
**  This file contains aes functions.   
**
** History:
**-----------------------------------------------------------------------------
...
/******************************************************************************
             GLOBAL IMPORTED VARIABLES DEFINITIONS SECTION
******************************************************************************/
...
******************************************************************************/
unsigned char  AES_iv[] = "0123456789abcdef";  /* align */
...
int device_aes_encrypt(unsigned char * key,unsigned char  *data, unsigned int len)
{
    unsigned char  i;
	Aes enc;
	unsigned int dat_len=len;
...
unsigned char device_aes_decrypt(unsigned char * key,unsigned char *data, unsigned int len)
{
	unsigned int dat_len= len;
	Aes dec;
